...
// Debug GUI 
// ---------
const char* windowTitle = "Verilator Sim: PCXT";
...
SimClock clk_sys(7);	// 14
SimClock clk_sys2(14);	// 7
SimClock clk_cpu(14);	// 7
