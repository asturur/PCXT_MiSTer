...
* Use SDRAM as system memory. Currently BRAM and SRAM are used for everything, providing the system with 640Kb of RAM (SRAM), 64Kb for the BIOS (BRAM) and 64Kb for VRAM (BRAM).
